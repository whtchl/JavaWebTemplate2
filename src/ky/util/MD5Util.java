...
public class MD5Util {  
     ...
     * @return
     */
    public static String getMD5UpString(String s) {  
        try {
			return getMD5String(s.getBytes("utf-8")).toUpperCase();
		} catch (UnsupportedEncodingException e) {
			// TODO Auto-generated catch block
...
//        System.out.println("md5:" + md5 + " time:" + ((end - begin) / 1000) + "s");  
        ...
        System.out.println( getMD5String(RandomUtil.getRandStr(8)));
        
        System.out.println( getMD5UpString("13140111379123456").substring(0, 16));
