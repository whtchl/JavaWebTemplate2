		...
		<div class="easyui-layout" data-options="fit:true">
			<form id="TSysRoleSaveForm" method="post" > 
				<div data-options="region:'center'" style="padding:10px;">
					<p>roleName:&nbsp;&nbsp;<input class="easyui-validatebox" data-options="required:true,missingMessage:'字段不可以为空'" name="roleName" ></p> 
					<p>levels:&nbsp;&nbsp;<input class="easyui-validatebox" data-options="required:true,missingMessage:'字段不可以为空'" name="levels" ></p> 
				...
				<div data-options="region:'south',border:false" style="text-align:right;padding:10px;padding-bottom: 5px;" >
					<a class="easyui-linkbutton" data-options="iconCls:'icon-ok'" href="javascript:void(0)" style="margin-right: 15px " onclick="add_save('TSysRoleSaveForm','tsysrole')">添加</a>
