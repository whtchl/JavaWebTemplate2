...
<HTML xmlns="http://www.w3.org/1999/xhtml"> 
	...
	<BODY>   
		...
		<div class="easyui-layout" data-options="fit:true">
			<form id="PmsDictionarySaveForm" method="post" > 
				...
				<div data-options="region:'south',border:false" style="text-align:right;padding:10px;padding-bottom: 5px;" >
					<a class="easyui-linkbutton" data-options="iconCls:'icon-ok'" href="javascript:void(0)" style="margin-right: 15px " onclick="add_save('PmsDictionarySaveForm','pmsdictionary')">添加</a>
					<a class="easyui-linkbutton" data-options="iconCls:'icon-cut'" href="javascript:void(0)" style="margin-right: 15px " onclick="doReset('PmsDictionarySaveForm')">重置</a>
				</div>
			</form>
		</div>
